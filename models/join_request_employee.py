class JoinRequestEmployee:
    def __init__(self, request_id=0, employee_id=0, event_date=0, event_location='', event_description='',
                 ...
                 head_approval=False, benco_approval=False, dept_id=0, employee_name='', supervisor_id=0, current_funds=0):
    ...
    def parse_json(json):
        ...
        new_join.current_funds = json['currentFunds']
        new_join.employee_name = json['employeeName']
        new_join.supervisor_id = json['supervisorId']
